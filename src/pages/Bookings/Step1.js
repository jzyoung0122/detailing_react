...
export default function Step1() {
    ...
    <span className=' text-gray-500 text-base  '><SlArrowRight className='inline-block'/> Please choose car body styles and services</span>
          ...
          {item.service.map(service=>(
            ...
            <input type='checkbox' 
              ...
              <div  className={service.checked?("rounded-lg border-2 border-gray-500 cursor-pointer p-2 relative"):("rounded-lg border-2 border-gray-200 cursor-pointer p-2 relative")} >
                ...
                <div className='flex flex-row-reverse'>{`price:$${service.price} durition:${service.time}h`}</div>
              </div>
            </Label>
          )             
          )}
